...
Our evaluation framework is built around classes from PCL \cite{Rusu2011} and VTK \cite{vtk}.
...
The other detectors that we are publishing are variants that replace FPFH with other local features supported by PCL. There are branches using PFH \cite{Rusu2009}, spin images \cite{Johnson99}, and SHOT \cite{shot}.
